...
public:
    ...
    {
        if (sConfigMgr->GetOption<bool>("MPBMorphs.Enable", false))
        {
     
            std::string playerName = player->GetName();

            std::vector<std::string> characterNamesToGrowVector = parseNamesStringToVector(sConfigMgr->GetOption<std::string>("MPBMorphs.CharacterNamesToScaleUp", ""), ",");
            std::vector<std::string> characterNamesToUseAlexstrazaModelId = parseNamesStringToVector(sConfigMgr->GetOption<std::string>("MPBMorphs.AlexstrazaMorphNames", ""), ",");
            std::vector<std::string> characterNamesToUseSylvanasModelId = parseNamesStringToVector(sConfigMgr->GetOption<std::string>("MPBMorphs.SylvanasMorphNames", ""), ",");
            std::vector<std::string> characterNamesToUseVeeresaModelId = parseNamesStringToVector(sConfigMgr->GetOption<std::string>("MPBMorphs.VeeresaMorphNames", ""), ",");
            std::vector<std::string> characterNamesToUseBEMaleModelId = parseNamesStringToVector(sConfigMgr->GetOption<std::string>("MPBMorphs.BEMaleMorphNames", ""), ",");
            std::vector<std::string> characterNamesToUseDraeneiFemaleModelId = parseNamesStringToVector(sConfigMgr->GetOption<std::string>("MPBMorphs.DraeneiFemaleMorphNames", ""), ",");
